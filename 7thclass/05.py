...
# Train Perceptron with Tanh Function
weights_tanh, bias_tanh = train_perceptron(X_train, y_train, 0.1, 10, "tanh")
plot_decision_boundary(X_train, y_train, weights_tanh, bias_tanh, "tanh")
