...
# Assuming the dataset has three feature columns and one binary label column
X = df.iloc[:, :-1].values
y = df.iloc[:, -1].values
...
learning_rate = 0.1
epochs = 10
activation_function_type = "sigmoid"  # Change to "tanh" or "relu" to test other activations
