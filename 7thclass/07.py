...
# Train and plot decision boundaries for different activation functions
activations = ["sigmoid", "relu", "tanh", "step"]
for activation in activations:
    weights, bias = train_perceptron(X_train, y_train, 0.1, 10, activation)
    plot_decision_boundary(X_train, y_train, weights, bias, activation)
